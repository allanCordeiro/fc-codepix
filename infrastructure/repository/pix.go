...
func (r PixKeyRepositoryDb) FindKeyByType(key string, pixType string) (*model.PixKey, error) {
	var pixKey model.PixKey
	r.Db.Preload("Account.Bank").First(&pixKey, "pix_type = ? and key = ?", pixType, key)
...
func (r PixKeyRepositoryDb) FindKeyById(key string, pixType string) (*model.PixKey, error) {
	var pixKey model.PixKey
